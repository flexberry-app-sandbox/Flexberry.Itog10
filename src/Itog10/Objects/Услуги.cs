...
namespace IIS.Itog10
{
    ...
    [View("УслугиE", new string[] {
            "Наименование as \'Наименование\'",
            "ЗатрВремя",
            "ЗатрВремя.Наименование as \'Затраченное время\'"})]
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog10.Услуга fНаименование;
        
        private IIS.Itog10.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Itog10.Услуга Наименование
        {
            get
            {
                ...
                IIS.Itog10.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Itog10.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Itog10.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Itog10.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Itog10.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.Itog10.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Itog10.Услуги));
                }
            }
        }
    }
