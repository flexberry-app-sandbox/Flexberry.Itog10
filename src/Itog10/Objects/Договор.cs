...
namespace IIS.Itog10
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "Тип as \'Тип\'",
            "Длительность",
            "Длительность.Номер as \'Срок действия\'",
            "Стоимость as \'Стоимость\'",
            "ДирОтдПоРабСКл as \'Директор\'",
    ...
    [View("ДоговорL", new string[] {
            ...
            "Статус as \'Статус\'",
            "Тип as \'Тип\'",
            "Длительность.Номер as \'Длительность действия\'",
            "Стоимость as \'Стоимость\'",
            "ДирОтдПоРабСКл.Фамилия as \'Фамилия директора\'",
            "Клиент.Фамилия as \'Фамилия клиента\'"})]
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog10.Статус fСтатус;
        
        private IIS.Itog10.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog10.Клиент fКлиент;
        
        private IIS.Itog10.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Itog10.Длительность fДлительность;
        ...
        public virtual IIS.Itog10.Статус Статус
        {
            get
            {
                ...
                IIS.Itog10.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog10.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog10.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog10.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog10.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog10.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog10.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog10.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog10.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog10.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog10.Договор));
                }
            }
        }
    }
