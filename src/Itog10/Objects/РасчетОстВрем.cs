...
namespace IIS.Itog10
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog10.DetailArrayOfОказУслуг fОказУсл;
        ...
        public virtual IIS.Itog10.DetailArrayOfОказУслуг ОказУсл
        {
            get
            {
                ...
                {
                    this.fОказУсл = new IIS.Itog10.DetailArrayOfОказУслуг(this);
                }
                IIS.Itog10.DetailArrayOfОказУслуг result = this.fОказУсл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Itog10.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Itog10.РасчетОстВрем));
                }
            }
        }
    }
