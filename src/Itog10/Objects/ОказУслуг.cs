...
namespace IIS.Itog10
{
    ...
    [View("ОказУслугE", new string[] {
            ...
            "Услуги as \'Услуги\'",
            "Услуги.Наименование as \'Наименование услуги\'",
            "Услуги.ЗатрВремя.Наименование as \'Затраченное время\'"})]
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog10.Услуги fУслуги;
        
        private IIS.Itog10.Договор fДоговор;
        
        private IIS.Itog10.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Itog10.Договор Договор
        {
            get
            {
                ...
                IIS.Itog10.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Itog10.Услуги Услуги
        {
            get
            {
                ...
                IIS.Itog10.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itog10.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Itog10.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Itog10.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Itog10.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itog10.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Itog10.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Itog10.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Itog10.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Itog10.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itog10.ОказУслуг dataobject)
        {
