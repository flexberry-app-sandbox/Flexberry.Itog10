...
moduleForModel('директор-отдела-по-работе-с-клиентами', 'Unit | Serializer | директор-отдела-по-работе-с-клиентами', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:директор-отдела-по-работе-с-клиентами',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
